...
from .yolo import get_pose_net_yolov5s, get_pose_net_yolov5l6, get_pose_net_yolov5x6
...
_model_factory = {
  ...
  'yolov5s': get_pose_net_yolov5s,
  'yolov5l6': get_pose_net_yolov5l6,
  'yolov5x6': get_pose_net_yolov5x6
}
